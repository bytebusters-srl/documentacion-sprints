...
\label{cap:sprint5}
\resumenCapitulo{Quinto y último incremento: despliegue, empaquetado monolítico y cierre de la
versión 2.0.0, junto con estadísticas, adaptabilidad y el lanzamiento final de EthosHub.}
