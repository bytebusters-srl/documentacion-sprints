...
Se implementaron políticas automatizadas de respaldos (\textit{backups}) sobre Supabase y
protocolos de recuperación ante contingencias, definiendo la frecuencia de copia y el
procedimiento de restauración.

\begin{NotaTecnica}
Las migraciones se aplican sobre Supabase de forma controlada; cada script se revisa antes de
ejecutarlo en un entorno compartido para preservar la integridad del schema \comando{core}.
\end{NotaTecnica}
...
\begin{table}[!ht]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \rowcolor{grisTecnico}
        Respaldo programado & Copia periódica gestionada por Supabase. \\ \hline
