...
\resumenCapitulo{Síntesis del recorrido completo del producto: balance de los seis incrementos,
cumplimiento de los objetivos planteados y lecciones aprendidas por el equipo de Byte Busters
S.R.L.}
...
incepción (Sección~\ref{ssec:s0_dod}). El producto se publica en el dominio
\url{http://bytebusters.tis.cs.umss.edu.bo}, con la base de datos PostgreSQL~15.10 administrada
vía phpPgAdmin y el código fuente en los repositorios GitHub \comando{EthosBack} y
\comando{EthosFront}.

\section{Documentación Relacionada}
\label{sec:concl_docs}
Esta memoria se complementa con el resto del corpus documental de EthosHub v2.0.0: el
\textbf{Manual Técnico de Arquitectura y Diseño} (\texttt{01\_Manual-Tecnico}), el \textbf{Manual
de Instalación} (\texttt{02\_Manual-Instalacion}) —que detalla el despliegue sobre el servidor
TIS—, el \textbf{Manual de Usuario} (\texttt{03\_Manual-Usuario}) y la \textbf{Convocatoria
CPTIS-2302-2026} (\texttt{00\_Convocatoria-CPTIS}).
