...
% =============================================================================
\chapter{Anexo Q — Estructura de los Repositorios}
\label{cap:anexo_repos}

Árbol de directorios real de ambos repositorios, base de la organización \textit{vertical slice}
(backend) y \textit{feature-first} (frontend).\par

\section{Backend (\texttt{ethoshubB})}
...
\section{Frontend (\texttt{ethoshubF})}
...
% =============================================================================
\chapter{Anexo R — Convenciones de Código y Control de Versiones}
