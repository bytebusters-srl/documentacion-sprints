...
% =============================================================================
\chapter{Anexo K — Configuración y Variables de Entorno}
...
\section{Variables del Backend (\texttt{ethoshubB})}
...
\comando{DATABASE\_URL} & JDBC URL (Supabase pooler). & --- \\ \hline
\rowcolor{grisTecnico}
...
\section{Variables del Frontend (\texttt{ethoshubF})}
