...
% Base de datos documentada a partir del esquema real aplicado a Supabase
% (migraciones V1–V15 del repositorio ethoshubB), schema `core`.
% =============================================================================
\chapter{Anexo A — Catálogo Completo de Endpoints REST}
\label{cap:anexo_endpoints}

Este anexo consolida los \textit{endpoints} expuestos por el backend \comando{ethoshubB} a lo
...
% =============================================================================
\chapter{Anexo B — Diccionario de Datos (schema \texttt{core})}
\label{cap:anexo_datos}

Diccionario de datos del schema \comando{core} de la base PostgreSQL gestionada por Supabase,
...
\textbf{Tabla \comando{core.profiles\_basic}} — perfil del profesional.
...
\textbf{Tabla \comando{core.profiles\_company}} — perfil del reclutador.
\renewcommand{\arraystretch}{1.25}
\fontsize{8.6}{10.3}\selectfont\sffamily
\begin{tabularx}{\textwidth}{|l|l|X|}
\hline
...
\textbf{Tabla \comando{core.profile\_security\_codes}} — códigos OTP (V4).
\renewcommand{\arraystretch}{1.25}
\fontsize{8.6}{10.3}\selectfont\sffamily
\begin{tabularx}{\textwidth}{|l|l|X|}
\hline
...
% =============================================================================
\chapter{Anexo C — Catálogo de Funciones RPC y Triggers}
\label{cap:anexo_rpc}
...
% =============================================================================
\chapter{Anexo D — Políticas RLS y Seguridad de Datos}
\label{cap:anexo_rls}
...
\comando{recruiter\_candidate\_notes} & \comando{rcn\_owner\_all} & \comando{company\_profile\_id = auth.uid()}. \\ \hline
\rowcolor{grisTecnico}
\comando{profile\_likes} & \comando{profile\_likes\_owner\_select} & \comando{basic\_profile\_id = auth.uid()} (SELECT). \\ \hline
...
% =============================================================================
\chapter{Anexo E — Catálogo de Migraciones SQL}
\label{cap:anexo_migraciones}

Listado cronológico de las migraciones \comando{V1}--\comando{V15} aplicadas sobre Supabase,
con el sprint en que se documentan.\par
...
% =============================================================================
\chapter{Anexo F — Matriz de Trazabilidad Épicas $\leftrightarrow$ Sprints}
