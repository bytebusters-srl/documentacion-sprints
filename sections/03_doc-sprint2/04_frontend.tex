...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/img/ethoshub/habilidades.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/img/ethoshub/trayectoria.png}
    \caption{Vista de gestión de trayectoria profesional.}
    \label{fig:s22_ui}
\end{figure}
