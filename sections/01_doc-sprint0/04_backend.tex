...
El andamiaje del backend (\comando{EthosBack}) se construyó sobre Spring Boot 4.0.6 con Maven,
...
\begin{NotaTecnica}
El flujo de \comando{build.sh} compila \comando{../EthosFront} con Node, copia \comando{dist/} a
