...
externos de los que depende: \textbf{Supabase} (autenticación, base de datos PostgreSQL y
\textit{Realtime}), \textbf{Google Gemini} (servicios de IA), \textbf{Google Drive}
...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}[
        ...
        \node[store, right=2.2cm of repo] (db) {PostgreSQL (Supabase)};
...
\begin{table}[!ht]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|}
        ...
        \rowcolor{grisTecnico}
        Base de datos & PostgreSQL (Supabase) & RLS, RPCs \comando{SECURITY DEFINER} y \textit{pooler} gestionado. \\ \hline
