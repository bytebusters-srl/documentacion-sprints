...
\newtcolorbox{BreakingChange}{
    ...
    leftrule=6pt,
    arc=2pt,
    title={\faExclamationTriangle\ \textbf{Cambio Crítico}},
    coltitle=black,
    fonttitle=\sffamily,
    attach title to upper=\par\vspace{0.2em}
}
...
% --- ESTILO DE CÓDIGO FUENTE (listings) ---
\definecolor{codeBg}{HTML}{F7F9FC}
\definecolor{codeKeyword}{HTML}{1A75FB}
\definecolor{codeComment}{HTML}{6A9955}
\definecolor{codeString}{HTML}{B5651D}
\definecolor{codeFrame}{HTML}{BBDDFC}

\lstdefinestyle{ethos}{
...
% Sintaxis Java/Spring básica adicional
...
% --- ENTORNO PARA EL PRODUCT BACKLOG ---
\newenvironment{TablaBacklog}{
    \par\vspace{0.2cm}\noindent
    \hbadness=10000 % Silencia los warnings de \hbox (cajas horizontales)
    \tabularx{\textwidth}{|l|>{\raggedright\arraybackslash\hspace{0pt}}X|c|c|c|>{\raggedright\arraybackslash\hspace{0pt}}X|}
    \hline
    \rowcolor{colorPrimario} 
    \textcolor{white}{\textbf{ID}} & 
    \textcolor{white}{\textbf{Descripción}} & 
    \textcolor{white}{\textbf{PRI}} & 
    \textcolor{white}{\textbf{EST.ESF.}} & 
    \textcolor{white}{\textbf{Sprint}} & 
    \textcolor{white}{\textbf{Prueba}} \\ \hline
}{
    \endtabularx
    \par\vspace{0.2cm}
}